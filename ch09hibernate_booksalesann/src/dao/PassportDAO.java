...
public class PassportDAO extends BaseHibernateDAO {
	...
	public List<Passport> findByExample(Passport instance) {
		...
		try {
			List<Passport> results = (List<Passport>) getSession().createCriteria("vo.Passport").add(create(instance))
					.list();
	...
	public List<Passport> findByPassportNo(Object passportNo) {
		return findByProperty(PASSPORT_NO, passportNo);
	}

	public List<Passport> findByPassportType(Object passportType) {
