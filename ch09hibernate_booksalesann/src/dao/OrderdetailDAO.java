...
public class OrderdetailDAO extends BaseHibernateDAO {
	...
	public List<Orderdetail> findByExample(Orderdetail instance) {
		...
		try {
			List<Orderdetail> results = (List<Orderdetail>) getSession().createCriteria("vo.Orderdetail")
	...
	public List<Orderdetail> findByBookName(Object bookName) {
	...
	public List<Orderdetail> findByUnuprice(Object unuprice) {
