...
public class SellerDAO extends BaseHibernateDAO {
	...
	public List<Seller> findByExample(Seller instance) {
		...
		try {
			List<Seller> results = (List<Seller>) getSession().createCriteria("vo.Seller").add(create(instance)).list();
	...
	public List<Seller> findBySellerName(Object sellerName) {
		return findByProperty(SELLER_NAME, sellerName);
	}

	public List<Seller> findBySellerAccount(Object sellerAccount) {
		return findByProperty(SELLER_ACCOUNT, sellerAccount);
	}

	public List<Seller> findBySellerPassword(Object sellerPassword) {
		return findByProperty(SELLER_PASSWORD, sellerPassword);
	}

	public List<Seller> findByCreatedAmount(Object createdAmount) {
