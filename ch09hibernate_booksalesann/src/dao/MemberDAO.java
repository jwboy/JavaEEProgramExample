...
public class MemberDAO extends BaseHibernateDAO {
	...
	public List<Member> findByExample(Member instance) {
		...
		try {
			List<Member> results = (List<Member>) getSession().createCriteria("vo.Member").add(create(instance)).list();
	...
	public List<Member> findByUsername(Object username) {
	...
	public List<Member> findByResume(Object resume) {
		return findByProperty(RESUME, resume);
	}

	public List<Member> findByPhoto(Object photo) {
