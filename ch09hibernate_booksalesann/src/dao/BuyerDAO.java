...
public class BuyerDAO extends BaseHibernateDAO {
	...
	public List<Buyer> findByExample(Buyer instance) {
		...
		try {
			List<Buyer> results = (List<Buyer>) getSession().createCriteria("vo.Buyer").add(create(instance)).list();
	...
	public List<Buyer> findByBuyerName(Object buyerName) {
		return findByProperty(BUYER_NAME, buyerName);
	}

	public List<Buyer> findByBuyerAccount(Object buyerAccount) {
		return findByProperty(BUYER_ACCOUNT, buyerAccount);
	}

	public List<Buyer> findByBuyerPassword(Object buyerPassword) {
		return findByProperty(BUYER_PASSWORD, buyerPassword);
	}

	public List<Buyer> findByBuyFrequency(Object buyFrequency) {
