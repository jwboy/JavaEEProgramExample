...
public class BookDAO extends BaseHibernateDAO {
	...
	public List<Book> findByExample(Book instance) {
		...
		try {
			List<Book> results = (List<Book>) getSession().createCriteria("vo.Book").add(create(instance)).list();
	...
	public List<Book> findByBookName(Object bookName) {
		return findByProperty(BOOK_NAME, bookName);
	}

	public List<Book> findByBookPrice(Object bookPrice) {
