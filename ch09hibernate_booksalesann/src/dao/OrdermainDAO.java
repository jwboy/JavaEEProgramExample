...
public class OrdermainDAO extends BaseHibernateDAO {
	...
	public List<Ordermain> findByExample(Ordermain instance) {
		...
		try {
			List<Ordermain> results = (List<Ordermain>) getSession().createCriteria("vo.Ordermain")
	...
	public List<Ordermain> findByOrderName(Object orderName) {
		return findByProperty(ORDER_NAME, orderName);
	}

	public List<Ordermain> findByOrderStatus(Object orderStatus) {
		return findByProperty(ORDER_STATUS, orderStatus);
	}

	public List<Ordermain> findByBuyerName(Object buyerName) {
